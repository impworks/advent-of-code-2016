...
void Main()
{
	...
	initialState.Items[State.ELERIUM] = 0;
	initialState.Items[State.ELERIUM + State.CHIP] = 0;
	initialState.Items[State.DILITIUM] = 0;
	initialState.Items[State.DILITIUM + State.CHIP] = 0;
...
public class State
{
	...
	public const int ELEMENTS_COUNT = 7;
    ...
    public const int ELERIUM = 10;
    public const int DILITIUM = 12;
