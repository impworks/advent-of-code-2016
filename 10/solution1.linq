...
void Main()
{
	...
	// processing
	var network = new BotNetwork(17, 61);
	var result = network.ProcessNetwork(source);
...
class BotNetwork
{
	public BotNetwork(int targetLo, int targetHi)
	{
		_targetLo = targetLo;
		_targetHi = targetHi;
	...
	private int _targetLo;
	private int _targetHi;
	private int? _targetId;
	
	public int ProcessNetwork(string[] commands)
	{
